                    ...
                    <div id="site-main-nav-container">
                        <nav>
                            <ul>
                                ...
                                <li><a class="active_link" href="contact.php">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                </section>
    ...
    <div class="container">
        <div class="row contactFrame">
            <section class="col-lg-6">
                <div id="contact-info">
                    <h2>Contact Us</h2>
                    <p>Need help getting your home or office organized? We’re here to help! Contact us using the form or
                        feel free to call or email us using the information provided. Our team of professional
                        organizers is available to answer any questions you may have about our services, pricing, and
